...
% probabilisitic (confidence) estimates.
...
for distanceMetric = 1:distanceMetricCount
    ...
    resultsAddress = ['../../output/identity_confidence_data_' num2str(distanceMetric-1) '.txt'];
	...
	set (h,'papersize',[3 4])
	set (h,'paperposition', [0,0,[3 4]])
	figureAddress = ['../../output/identity_confidence_pts_' num2str(distanceMetric-1) '.pdf'];
	print(h, figureAddress, '-dpdf', '-landscape');
    
    outputAddress = ['../../output/identity_confidence_pts_' num2str(distanceMetric-1) '.txt'];
