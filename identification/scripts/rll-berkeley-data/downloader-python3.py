# modifed from code originally at: http://rll.berkeley.edu/amazon_picking_challenge/
...
def fetch_objects(url):
	...
	html = response.read()
	objects = json.loads(html.decode('utf8'))
...
def download_file(url, filename):
	...
	print("Downloading: ", filename, " (", file_size/1000000.0, "MB)")
