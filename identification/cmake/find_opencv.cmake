...
LIST(APPEND OpenCV_Basic_Components_List "opencv_features2d")
LIST(APPEND OpenCV_Basic_Components_List "opencv_imgproc")
LIST(APPEND OpenCV_Basic_Components_List "opencv_nonfree")

LIST(APPEND OpenCV_Components_List ${OpenCV_Basic_Components_List})

MESSAGE(STATUS "USERPROFILE_FOR_OPENCV = ${USERPROFILE_FOR_OPENCV}")
SET(OPENCV_HINTS "/usr/local/share/OpenCV" "${USERPROFILE_FOR_OPENCV}/Documents/opencv/build" "C:/Users/Public/Documents/opencv/build" "${USERPROFILE_FOR_OPENCV}/Documents/Code/BUILDS/opencv/build" "${USERPROFILE_FOR_OPENCV}/Documents/GitHub/BUILDS/OpenCV" "${USERPROFILE_FOR_OPENCV}/Documents/opencv/build")
find_package(OpenCV 2.4.8 COMPONENTS ${OpenCV_Components_List} QUIET HINTS ${OPENCV_HINTS})
...
IF(OpenCV_FOUND AND ("${OpenCV_DIR}" STREQUAL "${OpenCV_CONFIG_PATH}") AND (NOT("${OpenCV_LIB_DIR_DBG}" STREQUAL "/Debug")) AND (NOT("${OpenCV_LIB_DIR_OPT}" STREQUAL "/Release")) )
	...
	LIST(APPEND _OpenCV_LIB_PATH "${OpenCV_LIB_DIR_DBG}")
	LIST(APPEND _OpenCV_LIB_PATH "${OpenCV_LIB_DIR_OPT}")
...
LIST(APPEND OpenCV_DLLs_List "opencv_imgproc" "opencv_flann" "opencv_features2d" "imgcodecs" "opencv_nonfree")
